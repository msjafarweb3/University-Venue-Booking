...
FIREBASE_WEB_API_KEY = os.environ.get('FIREBASE_WEB_API_KEY', 'AIzaSyADPiqlwNl8WTGrHTs5ZrxyeOxVpc2B0co') # REPLACE WITH YOUR ACTUAL WEB API KEY!

# --- Email Configuration (Replace with your actual details) ---
# For a real application, use environment variables for these
EMAIL_ADDRESS = os.environ.get('EMAIL_USER', 'jafarmuhammadsani625@gmail.com') # e.g., "your_email@gmail.com"
EMAIL_PASSWORD = os.environ.get('EMAIL_PASS', 'xyvs ixuh wkbv avin') # Your app password or actual password
